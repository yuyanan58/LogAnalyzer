...
<ul class="nav main">
    ...
    <li class="ic-form-style"><a href="javascript:"><span>控制台</span></a>
        <ul>
            <li><a href="form-controls.jsp">表单</a> </li>
            <li><a href="image-gallery.jsp">图片展示</a> </li>            
            <li><a href="gallery-with-filter.jsp">图片选择展示</a> </li>
            <li><a href="table.jsp">表格</a> </li>
            <li><a href="buttons.jsp">按钮</a> </li>
        </ul>
    </li>
    <li class="ic-notifications"><a href="notifications.jsp"><span>关于我们</span></a></li>
</ul>
<!-- I am nav end -->